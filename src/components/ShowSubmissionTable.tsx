    ...
    <Box p={3}>
      ...
      <TableContainer component={Paper} elevation={3}>
        <Table>
          <TableHead>
            <TableRow>
              <TableCell><Business fontSize="small" /> Business Name</TableCell>
              <TableCell><Email fontSize="small" /> Email</TableCell>
              <TableCell><Web fontSize="small" /> Website</TableCell>
              <TableCell><Phone fontSize="small" /> Phone</TableCell>
              <TableCell><LocationOn fontSize="small" /> Address</TableCell>
